...
object Dependencies {
    ...
    const val LIFECYCLE_VIEWMODEL = Libs.LIFECYCLE_VIEWMODEL + ":" + Versions.LIFECYCLE_VIEWMODEL
    const val LOTTIE = Libs.LOTTIE + ":" + Versions.LOTTIE
    ...
    const val RECYCLER_VIEW_SELECTION =
        Libs.RECYCLER_VIEW_SELECTION + ":" + Versions.RECYCLER_VIEW_SELECTION
